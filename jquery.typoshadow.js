(function($){
    ...
    function typoShadow(e){
        ...
        $typo.css('text-shadow', '0 1px 0 #ccc,' +
                                ...
                                10 * -x + 'px ' + 10 * y + 'px 10px rgba(255,255,255),' +
                                30 * -x + 'px ' + 3 * y + 'px 10px rgba(255,255,255,0.2),' +
                                50 * -x + 'px ' + 5 * y + 'px 20px rgba(255,255,255,0.25),' +
                                100 * -x + 'px ' + 10 * y + 'px 20px rgba(255,255,255,0.2),' +
                                200 * -x + 'px ' + 20 * y + 'px 40px rgba(255,255,255,0.15)');
    }
